...
<script src="${pageContext.servletContext.contextPath}/resources/assets/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside-mini-cache.js"></script>
...
<main id="content" role="main" class="main">
  ...
  <div class="container">
    <a class="position-absolute top-0 start-0 end-0 py-4" href="./index.html">
      <img class="avatar avatar-xl avatar-4x3 avatar-centered" src="${pageContext.servletContext.contextPath}/resources/assets/svg/logos/logo.svg" alt="Image Description" data-hs-theme-appearance="default">
      <img class="avatar avatar-xl avatar-4x3 avatar-centered" src="${pageContext.servletContext.contextPath}/resources/assets/svg/logos-light/logo.svg" alt="Image Description" data-hs-theme-appearance="dark">
    </a>
      ...
      <div class="row justify-content-center align-items-sm-center w-100">
        <div class="col-9 col-sm-6 col-lg-4">
          <div class="text-center text-sm-end me-sm-4 mb-5 mb-sm-0">
            <img class="img-fluid" src="${pageContext.servletContext.contextPath}/resources/assets/svg/illustrations/oc-thinking.svg" alt="Image Description" data-hs-theme-appearance="default">
            <img class="img-fluid" src="${pageContext.servletContext.contextPath}/resources/assets/svg/illustrations-light/oc-thinking.svg" alt="Image Description" data-hs-theme-appearance="dark">
          </div>
        </div>
        <!-- End Col -->
        ...
        <div class="col-sm-6 col-lg-4 text-center text-sm-start">
          ...
          <p class="lead">Логин ёки паролингиз топилмади</p>
          <a class="btn btn-primary" href="${pageContext.servletContext.contextPath}/">Қайта уриниб кўриш</a>
        </div>
        <!-- End Col -->
      </div>
      <!-- End Row -->
  ...
  <div class="footer text-center">
    <ul class="list-inline list-separator">
      <li class="list-inline-item">
        <a class="list-separator-link" href="#">Техник ёрдам (7719)</a>
      </li>
    </ul>
  </div>
  <!-- End Footer -->
