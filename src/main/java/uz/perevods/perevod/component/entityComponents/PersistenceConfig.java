...
//@EnableJpaRepositories(basePackages = { "uz.perevods.perevod.repository" }, transactionManagerRef = "jpaTransactionManager", entityManagerFactoryRef = "jpaEntityManager")
//@EnableJpaAuditing(auditorAwareRef = "auditorProvider")
//@PropertySource({ "classpath:persistence-h2.properties" })
//@ComponentScan({ "uz.perevods.perevod" })
...
//        sessionFactory.setPackagesToScan(new String[] { "uz.perevods.perevod.entity" });
...
//        emf.setPackagesToScan(new String[] { "uz.perevods.perevod.entity" });
//
